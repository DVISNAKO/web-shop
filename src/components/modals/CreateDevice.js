      ...
      >
        ...
        <Modal.Body>
            <Form>
                ...
                <Form.Control 
                className='mt-3'
                placeholder='Ввведите название устройста'/>
                  <Form.Control 
                className='mt-3'
                placeholder='Ввведите стоимость устройста'
                type="number"/>
                  <Form.Control 
                className='mt-3'
                type="file"/>
        ...
        <Modal.Footer>
          <Button variant='outiline-danger'  onClick={onHide}>Закрыть</Button>
          <Button variant='outiline-success' onClick={onHide}>Добавить</Button>
        </Modal.Footer>
      </Modal>
    );
};
